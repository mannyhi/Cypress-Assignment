...
When('the user adds {string}, {string}, {string}, {string} to the cart', (item1, item2, item3, item4) => {
  cy.contains(item1).parent().find('button').click()
  cy.contains(item2).parent().find('button').click()
  cy.contains(item3).parent().find('button').click()
  cy.contains(item4).parent().find('button').click()
